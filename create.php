...
if (isset($_POST['usuario']) && isset($_POST['contraseña'])) {
    ...
    $resultado = $controlarSesion->create($_POST['usuario'], $_POST['nombre'], $_POST['apellido'], $_POST['contraseña']);
    if ($resultado[0] === true) {
...
<form action="create.php" method="post">
    ...
    <input name="nombrePyme" class="form-control form-control-lg" placeholder="Nombre de tu emprendimiento"><br>
